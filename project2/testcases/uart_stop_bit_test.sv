class uart_stop_bit_test extends uart_base_test;
  ...
  uart_stop_bit_sequence  lhs_sequence;
  uart_stop_bit_sequence  rhs_sequence;

  function new(string name = "uart_stop_bit_test", uvm_component parent);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    for(int i = 1; i < 3; i++) begin
      ...
      lhs_sequence   = uart_stop_bit_sequence::type_id::create("lhs_sequence", this);
      rhs_sequence   = uart_stop_bit_sequence::type_id::create("rhs_sequence", this);
