class uart_txd_x16_random extends base_test;
  `uvm_component_utils(uart_txd_x16_random)

  random_x16_chk_sequence   random_seq;
  
  int baud_rate_a[7] = '{2400, 4800, 9600, 19200, 38400, 76800, 115200};

  function new(string name = "uart_txd_x16_random", uvm_component parent);
