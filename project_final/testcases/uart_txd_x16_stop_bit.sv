class uart_txd_x16_stop_bit extends base_test;
  `uvm_component_utils(uart_txd_x16_stop_bit)

  stop_bit_x16_chk_sequence   sb_seq;

  function new(string name = "uart_txd_x16_stop_bit", uvm_component parent);
