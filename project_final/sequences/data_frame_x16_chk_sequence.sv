class data_frame_x16_chk_sequence extends uvm_sequence;
  `uvm_object_utils(data_frame_x16_chk_sequence)
  ...
  function new(string name = "data_frame_x16_chk_sequence");
    super.new(name);
  endfunction
