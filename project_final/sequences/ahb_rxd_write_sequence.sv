class ahb_rxd_write_sequence extends uvm_sequence #(ahb_transaction);
  `uvm_object_utils(ahb_rxd_write_sequence)
  ...
  function new(string name = "ahb_rxd_write_sequence");
    super.new(name);
  endfunction
