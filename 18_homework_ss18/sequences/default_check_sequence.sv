class default_check_sequence extends uvm_sequence #(ahb_transaction);
  `uvm_object_utils(default_check_sequence)

  uart_reg_block  regmodel;
  uvm_status_e    status;
  uvm_reg_data_t  data;

  function new(string name = "default_check_sequence");
    super.new(name);
  endfunction
